...
foreach($device_keys as $row) {
	...
	<select class='formfld' style='width:80px;' name='device_keys[<?php echo $x; ?>][device_key_type]' id='key_type_<?php echo $x; ?>' onchange="document.getElementById('key_vendor_<?php echo $x; ?>').value=document.getElementById('key_type_<?php echo $x; ?>').options[document.getElementById('key_type_<?php echo $x; ?>').selectedIndex].parentNode.label.toLowerCase();">
		...
		if (strtolower($device_vendor) == "aastra" || strlen($device_vendor) == 0) {
			...
			<option value='acd' <?php if ($row['device_key_type'] == "acd") { echo $selected;$found=true; } ?>><?php echo $text['label-acd'] ?></option>
			<option value='blf' <?php if ($row['device_key_type'] == "blf") { echo $selected;$found=true; } ?>><?php echo $text['label-blf'] ?></option>
			<option value='list' <?php if ($row['device_key_type'] == "list") { echo $selected;$found=true; } ?>><?php echo $text['label-blf_list'] ?></option>
			<option value='blfxfer' <?php if ($row['device_key_type'] == "blfxfer") { echo $selected;$found=true; } ?>><?php echo $text['label-blf_xfer'] ?></option>
			<option value='callforward' <?php if ($row['device_key_type'] == "callforward") { echo $selected;$found=true; } ?>><?php echo $text['label-forward'] ?></option>
			<option value='callers' <?php if ($row['device_key_type'] == "callers") { echo $selected;$found=true; } ?>><?php echo $text['label-callers'] ?></option>
			<option value='conf' <?php if ($row['device_key_type'] == "conf") { echo $selected;$found=true; } ?>><?php echo $text['label-conference'] ?></option>
			<option value='delete' <?php if ($row['device_key_type'] == "delete") { echo $selected;$found=true; } ?>><?php echo $text['label-delete'] ?></option>
			<option value='dcp' <?php if ($row['device_key_type'] == "dcp") { echo $selected;$found=true; } ?>><?php echo $text['label-dcp'] ?></option>
			<option value='directory' <?php if ($row['device_key_type'] == "directory") { echo $selected;$found=true; } ?>><?php echo $text['label-directory'] ?></option>
			<option value='dnd' <?php if ($row['device_key_type'] == "dnd") { echo $selected;$found=true; } ?>><?php echo $text['label-dnd'] ?></option>
			<option value='empty' <?php if ($row['device_key_type'] == "empty") { echo $selected;$found=true; } ?>><?php echo $text['label-empty'] ?></option>
			<option value='filter' <?php if ($row['device_key_type'] == "filter") { echo $selected;$found=true; } ?>><?php echo $text['label-filter'] ?></option>
			<option value='flash' <?php if ($row['device_key_type'] == "flash") { echo $selected;$found=true; } ?>><?php echo $text['label-flash'] ?></option>
			<option value='icom' <?php if ($row['device_key_type'] == "icom") { echo $selected;$found=true; } ?>><?php echo $text['label-intercom'] ?></option>
			<option value='lcr' <?php if ($row['device_key_type'] == "lcr") { echo $selected;$found=true; } ?>><?php echo $text['label-lcr'] ?></option>
			<option value='paging' <?php if ($row['device_key_type'] == "paging") { echo $selected;$found=true; } ?>><?php echo $text['label-paging'] ?></option>
			<option value='park' <?php if ($row['device_key_type'] == "park") { echo $selected;$found=true; } ?>><?php echo $text['label-call_park'] ?></option>
			<option value='phonelock' <?php if ($row['device_key_type'] == "phonelock") { echo $selected;$found=true; } ?>><?php echo $text['label-keypad_lock'] ?></option>
			<option value='pickup' <?php if ($row['device_key_type'] == "pickup") { echo $selected;$found=true; } ?>><?php echo $text['label-call_pickup'] ?></option>
			<option value='redial' <?php if ($row['device_key_type'] == "redial") { echo $selected;$found=true; } ?>><?php echo $text['label-redial'] ?></option>
			<option value='save' <?php if ($row['device_key_type'] == "save") { echo $selected;$found=true; } ?>><?php echo $text['label-save'] ?></option>
			<option value='services' <?php if ($row['device_key_type'] == "services") { echo $selected;$found=true; } ?>><?php echo $text['label-services'] ?></option>
			...
			<option value='speeddialconf' <?php if ($row['device_key_type'] == "speeddialconf") { echo $selected;$found=true; } ?>><?php echo $text['label-speeddialconf'] ?></option>
			<option value='speeddialmwi' <?php if ($row['device_key_type'] == "speeddialmwi") { echo $selected;$found=true; } ?>><?php echo $text['label-speeddialmwi'] ?></option>
			<option value='speeddialxfer' <?php if ($row['device_key_type'] == "speeddialxfer") { echo $selected;$found=true; } ?>><?php echo $text['label-speeddialxfer'] ?></option>
			<option value='spre' <?php if ($row['device_key_type'] == "spre") { echo $selected;$found=true; } ?>><?php echo $text['label-spre'] ?></option>
			<option value='xfer' <?php if ($row['device_key_type'] == "xfer") { echo $selected;$found=true; } ?>><?php echo $text['label-xfer'] ?></option>
			<option value='xml' <?php if ($row['device_key_type'] == "xml") { echo $selected;$found=true; } ?>><?php echo $text['label-xml'] ?></option>
			<?php
